...
contragents_docs_two_colls = '(document_name, parent, deleted, contragent_name, doc_date, summ, doc_type, test_del, pp_detector, another_identif, another_id, type_sort)'
...
def full_update(list_number, base_number):
	update_from_dbf(documenty_dlya_contragentov[list_number], select_all_documents, base_number, contragents_docs_data, insert_into_docs)
	update_from_dbf(documenty_ot_contragentov[list_number], select_all_documents_two, base_number, contragents_docs_two_data, insert_into_docs_two)

	update_from_dbf(contragenty[list_number], select_contragents, base_number, contragents_data, insert_into_contragents)
	update_from_dbf(uslygi_okazany[list_number], sel_ishod_nds_usl, base_number, ishod_nds_usl_data, insert_usl_okaz_nds)
	update_from_dbf(nakladnye[list_number], sel_ishod_nds_tn, base_number, ishod_nds_tn_data, insert_tn_otpravl_nds)

	update_from_dbf(uslygi_polychenye[list_number], sel_vhod_usl_nds, base_number, vhod_nds_usl_data, insert_usl_poluch_nds)
	update_from_dbf(nakladnye_polychenye[list_number], sel_vhod_tn_nds, base_number, vhod_nds_tn_data, insert_tn_vhod_nds)

	update_from_dbf(tovary_polychenye[list_number], select_all_tovary, base_number, nds_tovary_data, insert_tovary)
	pass
