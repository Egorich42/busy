...
excel_outcome = 'result_{}_{}.xlsx'.format(data_type,agent_name)

if os.path.exists(excel_outcome) == True:
	filepath = BASE_DIR+'\\'+"result_{}_{}_{}.xlsx".format(data_type,agent_name, str(1))
